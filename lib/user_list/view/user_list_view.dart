  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Colors.pink.shade200, // Soft pink color
        centerTitle: true,
      ),
          ...
          if (state is UserListSuccess) {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      leading: CircleAvatar(
                        radius: 30,
                        backgroundColor: Colors.pink.shade200, // Soft pink circle
                        child: Text(
            ...
            return const Center(
              child: CircularProgressIndicator(
                color: Colors.pink, // Soft pink for loading indicator
              ),
            );
          } else {
            // Initial / First time
      ...
      floatingActionButton: FloatingActionButton(
        ...
        backgroundColor: Colors.pink.shade200, // Soft pink
